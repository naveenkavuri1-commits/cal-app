...
public class compknCalculatorFragment extends Fragment {
	...
	public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
		...
		for (int id : numberIds) {
			...
			if (v != null) v.setOnClickListener(view -> compknAppend(((Button) view).getText().toString()));
		}

		root.findViewById(R.id.compkn_btn_plus).setOnClickListener(v -> compknAppend("+"));
		root.findViewById(R.id.compkn_btn_minus).setOnClickListener(v -> compknAppend("-"));
		root.findViewById(R.id.compkn_btn_mul).setOnClickListener(v -> compknAppend("*"));
		root.findViewById(R.id.compkn_btn_div).setOnClickListener(v -> compknAppend("/"));
		root.findViewById(R.id.compkn_btn_decimal).setOnClickListener(v -> compknAppend("."));
		root.findViewById(R.id.compkn_btn_percent).setOnClickListener(v -> compknAppend("%"));
		root.findViewById(R.id.compkn_btn_lparen).setOnClickListener(v -> compknAppend("("));
		root.findViewById(R.id.compkn_btn_rparen).setOnClickListener(v -> compknAppend(")"));
		...
		root.findViewById(R.id.compkn_btn_recip).setOnClickListener(v -> compknAppend("1/("));

		root.findViewById(R.id.compkn_btn_sin).setOnClickListener(v -> compknAppend(compknIsSecond ? "asin(" : "sin("));
		root.findViewById(R.id.compkn_btn_cos).setOnClickListener(v -> compknAppend(compknIsSecond ? "acos(" : "cos("));
		root.findViewById(R.id.compkn_btn_tan).setOnClickListener(v -> compknAppend(compknIsSecond ? "atan(" : "tan("));
		root.findViewById(R.id.compkn_btn_ln).setOnClickListener(v -> compknAppend(compknIsSecond ? "exp(" : "ln("));
		root.findViewById(R.id.compkn_btn_log).setOnClickListener(v -> compknAppend(compknIsSecond ? "10^" : "log("));
		root.findViewById(R.id.compkn_btn_pi).setOnClickListener(v -> compknAppend("pi"));
		root.findViewById(R.id.compkn_btn_e).setOnClickListener(v -> compknAppend("e"));
		root.findViewById(R.id.compkn_btn_sqrt).setOnClickListener(v -> compknAppend("sqrt("));
		root.findViewById(R.id.compkn_btn_pow).setOnClickListener(v -> compknAppend("^"));
		root.findViewById(R.id.compkn_btn_fact).setOnClickListener(v -> compknAppend("!"));
	...
	private void compknAppend(String s) {
